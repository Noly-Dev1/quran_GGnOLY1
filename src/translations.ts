...
export const translations: Record<Language, TranslationSchema> = {
  ar: {
    ...
    schedule: { label: "جدول المواعيد", title: "اختاري ما يناسبكِ", note: "* جميع المواعيد المذكورة أعلاه هي حسب توقيت مكة المكرمة.", achievementsLabel: "إنجازات المعلمة", specialtiesLabel: "الحلقات المتاحة" },
  ...
  en: {
    ...
    schedule: { label: "Schedule", title: "Choose What Suits You", note: "* All mentioned times are according to Makkah time.", achievementsLabel: "Achievements", specialtiesLabel: "Specialized Circles" },
  ...
  fr: {
    ...
    schedule: { label: "Horaires", title: "Choisissez ce qui vous convient", note: "* Tous les horaires sont basés sur l'heure de La Mecque.", achievementsLabel: "Réalisations", specialtiesLabel: "Cercles spécialisés" },
  ...
  tr: {
    ...
    hero: { label: "Çevrimiçi Kuran Eğitim Hizmeti", title1: "Evinizde Bir", title2: "Işık", description: "Zoom üzerinden kadınlara eğitim. Doğrudan iletişim ve Tecvid ustalığı.", cta: "Şimdi Kaydol", dailyMessage: "Günün Mesajı", dailyQuote: "\"Sizin en hayırlınız Kuran'ı öğrenen ve öğreteninizdir.\"" },
    ...
    schedule: { label: "Program", title: "Size Uygun Olanı Seçin", note: "* Tüm saatler Mekke saatine göredir.", achievementsLabel: "Başarılar", specialtiesLabel: "Uzmanlık Halkaları" },
  ...
  id: {
    ...
    hero: { label: "Layanan Pendidikan Al-Quran Online", title1: "Cahaya di", title2: "Rumahmu", description: "Mengajar wanita via Zoom. Komunikasi langsung dan penguasaan Tajwid.", cta: "Daftar Sekarang", dailyMessage: "Pesan Hari Ini", dailyQuote: "\"Sebaik-baik kalian adalah yang mempelajari Al-Quran dan mengajarkannya.\"" },
    ...
    schedule: { label: "Jadwal", title: "Pilih yang Sesuai", note: "* Semua waktu berdasarkan waktu Makkah.", achievementsLabel: "Pencapaian", specialtiesLabel: "Halaqah Khusus" },
  ...
  ur: {
    ...
    hero: { label: "آن لائن قرآن تعلیم سروس", title1: "آپ کے گھر میں", title2: "ایک نور", description: "زوم کے ذریعے خواتین کی تعلیم۔ براہ راست رابطہ اور تجوید میں مہارت۔", cta: "رجسٹریشن کریں", dailyMessage: "آج کا پیغام", dailyQuote: "\"تم میں سے بہترین وہ ہے جو قرآن سیکھے اور سکھائے۔\"" },
    ...
    schedule: { label: "اوقات", title: "اپنے لیے مناسب وقت کا انتخاب کریں", note: "* تمام اوقات مکہ مکرمہ کے وقت کے مطابق ہیں۔", achievementsLabel: "اعزازات", specialtiesLabel: "دستیاب حلقے" },
