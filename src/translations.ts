...
export interface TranslationSchema {
  ...
  register: {
    ...
    circleOption1: string;
    circleOption2: string;
    juz: string;
    juzStart: string;
    juzOne: string;
    juzTwo: string;
...
export const translations: Record<Language, TranslationSchema> = {
  ar: {
    ...
    schedule: { label: "جدول المواعيد", title: "اختاري ما يناسبكِ", note: "* جميع المواعيد المذكورة أدناه هي حسب توقيت مكة المكرمة.", specialtiesLabel: "الحلقات المتاحة" },
  ...
  en: {
    ...
    register: { label: "Register Now", title1: "Let's Start", title2: "Connecting", description: "Fill out the form and we will contact you via WhatsApp for your free trial.", formTitle: "Registration Form", fullName: "Full Name", fullNamePlaceholder: "Write your name here...", age: "Age", agePlaceholder: "Example: 25", teacher: "Select Teacher", teacherPlaceholder: "Select Teacher...", circle: "Circle Type", circlePlaceholder: "Select Circle Type...", circleOption1: "Memorization & Revision", circleOption2: "Noorania", juz: "Juz Memorized?", juzStart: "Starting from scratch", juzOne: "1 Juz", juzTwo: "2 Juz", juzMultiple: "Juz", whatsapp: "WhatsApp Number", whatsappTitle: "Digits only please", notes: "Additional Notes", notesPlaceholder: "Timing preferences...", submit: "Submit", successTitle: "Thank You", successDesc: "Received Successfully", successMessage: "We will send trial details via WhatsApp.", error: "Sorry, an error occurred." },
    privacy: {
  ...
  fr: {
    ...
    register: { label: "S'inscrire", title1: "Commençons", title2: "À échanger", description: "Remplissez le formulaire pour votre essai gratuit via WhatsApp.", formTitle: "Inscription", fullName: "Nom complet", fullNamePlaceholder: "Votre nom...", age: "Âge", agePlaceholder: "Ex: 25", teacher: "Enseignante", teacherPlaceholder: "Choisir...", circle: "Type de cercle", circlePlaceholder: "Choisir le type...", circleOption1: "Mémorisation & Révision", circleOption2: "Noorania", juz: "Juz mémorisés ?", juzStart: "De zéro", juzOne: "1 Juz", juzTwo: "2 Juz", juzMultiple: "Juz", whatsapp: "WhatsApp", whatsappTitle: "Chiffres uniquement", notes: "Notes", notesPlaceholder: "Préférences d'horaire...", submit: "Envoyer", successTitle: "Merci", successDesc: "Reçu", successMessage: "Détails envoyés par WhatsApp.", error: "Une erreur est survenue." },
    privacy: {
  ...
  id: {
    ...
    register: { label: "Daftar Sekarang", title1: "Ayo", title2: "Terhubung", description: "Isi formulir dan kami akan menghubungi Anda untuk uji coba gratis.", formTitle: "Pendaftaran", fullName: "Nama Lengkap", fullNamePlaceholder: "Tulis nama Anda...", age: "Usia", agePlaceholder: "Contoh: 25", teacher: "Pilih Guru", teacherPlaceholder: "Pilih...", circle: "Tipe Halaqah", circlePlaceholder: "Pilih tipe...", circleOption1: "Hafalan & Murajaah", circleOption2: "Noorania", juz: "Juz yang Dihafal?", juzStart: "Mulai dari nol", juzOne: "1 Juz", juzTwo: "2 Juz", juzMultiple: "Juz", whatsapp: "Nomor WhatsApp", whatsappTitle: "Angka saja", notes: "Catatan", notesPlaceholder: "Preferensi waktu...", submit: "Kirim", successTitle: "Terima Kasih", successDesc: "Berhasil", successMessage: "Kami kirim detail via WhatsApp.", error: "Terjadi kesalahan." },
    privacy: {
  ...
  ur: {
    ...
    register: { label: "رجسٹریشن کریں", title1: "آئیں", title2: "رابطہ کریں", description: "فارم بھریں اور ہم ٹرائل سیشن کے لیے واٹس ایپ پر رابطہ کریں گے۔", formTitle: "رجسٹریشن فارم", fullName: "مکمل نام", fullNamePlaceholder: "نام لکھیں...", age: "عمر", agePlaceholder: "مثلاً: 25", teacher: "استانی", teacherPlaceholder: "منتخب کریں...", circle: "حلقے کی قسم", circlePlaceholder: "قسم منتخب کریں...", circleOption1: "حفظ اور دہرائی", circleOption2: "قاعدہ نورانیہ", juz: "کتنے پارے حفظ ہیں؟", juzStart: "صفر سے شروع", juzOne: "1 پارہ", juzTwo: "2 پارے", juzMultiple: "پارے", whatsapp: "واٹس ایپ نمبر", whatsappTitle: "صرف نمبر درج کریں", notes: "تفصیلات", notesPlaceholder: "وقت کی ترجیحات...", submit: "ڈیٹا بھیجیں", successTitle: "شکریہ", successDesc: "موصول ہوا", successMessage: "ہم واٹس ایپ پر تفصیلات بھیجیں گے۔", error: "معذرت، کوئی غلطی ہوئی ہے۔" },
    privacy: {
